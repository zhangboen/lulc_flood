...
outName = re.sub('final_dataset_', '', os.path.basename(fname).split('.')[0]) + '_simple'
...
if purpose == 'cv':
    ...
    for climate in df.climate_label.unique():
        ...
        res_df = aleplot_1D_continuous(train_set_rep, predictors, ml, feature, grid_size = 100, log = True, m3s = False, )
